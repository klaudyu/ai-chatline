 ...
 * 当前仅Default启用Follow up功能；保留Timeline/导出所需的通用适配入口，便于后续开启。
 * TODO: SITE_INFO 中 NotebookLM 的 timeline=false，当前不会注入Timeline顶部导出按钮；
 *       后续若需要在无Timeline页面展示导出入口，应新增独立页面入口而不是复用 TimelineManager。
 */
