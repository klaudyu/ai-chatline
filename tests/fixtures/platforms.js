const fixtures = [
    ...
    { id: 'yiyan', url: 'https://wenxin.baidu.com/search/demo', route: '/search/demo', selectorEvidence: 'conversation-flow-question-container', userHtml: '<div data-lid="lid1" class="conversation-flow-question-container questionText">Question</div>', assistantHtml: '<div data-lid="lid1" class="conversation-flow-answer-container answer-box answer"><div class="cosd-markdown">Answer</div></div>', inputHtml: '<textarea id="chat-textarea"></textarea>' },
